                        ...
                        <tr class="hover:bg-slate-50/80 transition">
                            ...
                            <td class="p-3.5 text-center whitespace-nowrap">
                                <div class="flex items-center justify-center gap-1.5">
                                    ...
                                    <!-- Unverify Form -->
                                    <form action="<?php echo e(route('overtime.unverify', $rec->id)); ?>" method="POST" class="inline" onsubmit="return confirm('के तपाईं यो रेकर्ड Unverify गर्न चाहनुहुन्छ? यो फेरि स्वीकृति-बाँकी (Recommended) अवस्थामा जान्छ।')">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" 
