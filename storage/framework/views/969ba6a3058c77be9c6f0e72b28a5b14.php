...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <!-- Search & Filter Form -->
    <form action="<?php echo e(route('overtime.recommended')); ?>" method="GET" class="bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 items-end">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="<?php echo e(route('overtime.recommended')); ?>" class="w-full bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium text-xs px-4 py-2.5 rounded-lg border border-slate-300 transition text-center">
                    Reset
                </a>
            </div>
        </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50/80 transition">
                            ...
                            <td class="p-3.5 text-slate-600 text-xs">
                                <?php echo e($rec->recommendedByUser->name ?? '-'); ?>

                                <?php if($rec->recommended_at): ?>
                                    <br><span class="text-slate-400"><?php echo e(adToBs($rec->recommended_at->toDateString())); ?></span>
                                <?php endif; ?>
                            </td>
                            <td class="p-3.5 text-center whitespace-nowrap">
                                <div class="flex items-center justify-center gap-2">
                                    <!-- Approve Button -->
                                    <form action="<?php echo e(route('overtime.verify', $rec->id)); ?>" method="POST" class="inline" onsubmit="return confirm('के तपाईं यो रेकर्ड स्वीकृत गर्न चाहनुहुन्छ?')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\overtime-system\resources\views/overtime/recommended.blade.php ENDPATH**/ ?>